  ...
  return (
    <section className="grid lg:grid-cols-[95%_5%] h-[100svh] lg:h-[80svh] ">
      <div className="relative bg-hero lg:rounded-r-[3rem]  bg-cover bg-center">
        <div className="bg-black/75 absolute h-full w-full top-0 left-0 lg:rounded-r-[3rem] ">
          <header className="absolute px-2 py-8 lg:p-32 text-white flex flex-col justify-center items-center md:items-start gap-8 lg:gap-8 text-center lg:text-left ">
            ...
            <Button
              className="w-[300px] lg:w-32 text-foreground "
              variant={"outline"}
            >
              Learn more
            </Button>
