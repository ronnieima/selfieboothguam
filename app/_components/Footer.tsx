  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <h2 className='text-2xl pb-2 text-bold mb-4'>Browse</h2>
        ...
        <div>
          <h2 className='text-2xl pb-2 text-bold mb-4'>Services</h2>
          <ul className='flex flex-col items-start gap-2'>
            <li>
        ...
        <div>
          <h2 className='text-2xl pb-2 text-bold mb-4'>Contact</h2>
          <ul className='flex flex-col items-start gap-2'>
      ...
      <div className='flex justify-between bg-slate-900 sm:px-16 px-4 py-2 items-center'>
